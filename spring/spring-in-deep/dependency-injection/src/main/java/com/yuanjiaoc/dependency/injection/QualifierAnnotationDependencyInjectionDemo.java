...
import com.yuanjiaoc.dependency.injection.annotation.UserGroup;
...
public class QualifierAnnotationDependencyInjectionDemo {
  ...
  @Autowired private Collection<User> allUsers; // 2 Beans = user + superUser

  @Autowired @Qualifier
  private Collection<User>
      qualifiedUsers; // 2 Beans = user1 + user2 -> 4 Beans = user1 + user2 + user3 + user4 继承
  // @UserGroup

  @Autowired @UserGroup private Collection<User> groupedUsers; // 2 Beans = user3 + user4
  ...
  public static void main(String[] args) {
    ...
    String xmlResourcePath = "classpath:/META-INF/qualifier-dependency.xml";
